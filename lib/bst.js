 ...
 * @param {Object} query Mongo-style query where keys are $lt, $lte, $gt or $gte
...
BinarySearchTree.prototype.betweenBounds = function (query, lbm, ubm) {
  ...
  if (ubm(this.key) && this.left) { append(res, this.left.betweenBounds(query, lbm, ubm)); }
  if (lbm(this.key) && this.right) { append(res, this.right.betweenBounds(query, lbm, ubm)); }
